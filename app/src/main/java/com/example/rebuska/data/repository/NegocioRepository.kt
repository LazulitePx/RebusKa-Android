...
object NegocioRepository {
    ...
    suspend fun actualizarNombre(id: String, nuevoNombre: String): Result<Unit> =
        FirestoreService.actualizarNegocio(id, mapOf("nombre" to nuevoNombre))

    suspend fun actualizarDescripcion(id: String, nuevaDescripcion: String): Result<Unit> =
        FirestoreService.actualizarNegocio(id, mapOf("descripcion" to nuevaDescripcion))
