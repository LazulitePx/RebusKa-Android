...
sealed class TiendaUiState {
    ...
    data class Exito(val negocio: Negocio, val publicaciones: List<Publicacion>) : TiendaUiState()
    ...
    fun cargar(idNegocio: String) {
        ...
        viewModelScope.launch {
            ...
            if (negocioResult.isFailure) {
                _uiState.value = TiendaUiState.Error("Negocio no encontrado")
                return@launch
            }
